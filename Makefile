...
Aura-Android-DebugGame:
	 $(BUILD) Aura Android DebugGame  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-Android-Development:
	 $(BUILD) Aura Android Development  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-Android-Shipping:
	 $(BUILD) Aura Android Shipping  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-Linux-DebugGame:
	 $(BUILD) Aura Linux DebugGame  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-Linux-Development:
	 $(BUILD) Aura Linux Development  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-Linux-Shipping:
	 $(BUILD) Aura Linux Shipping  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-LinuxArm64-DebugGame:
	 $(BUILD) Aura LinuxArm64 DebugGame  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-LinuxArm64-Development:
	 $(BUILD) Aura LinuxArm64 Development  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura-LinuxArm64-Shipping:
	 $(BUILD) Aura LinuxArm64 Shipping  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

Aura: Aura-Linux-Development

AuraEditor-Linux-DebugGame:
	 $(BUILD) AuraEditor Linux DebugGame  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

AuraEditor-Linux-Development:
	 $(BUILD) AuraEditor Linux Development  -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" $(ARGS)

AuraEditor: AuraEditor-Linux-Development

configure:
	$(BUILD) -ProjectFiles -Project="/mnt/new_partition/UnrealProjects/Aura_redoWithAi/Aura.uproject" -Game 
