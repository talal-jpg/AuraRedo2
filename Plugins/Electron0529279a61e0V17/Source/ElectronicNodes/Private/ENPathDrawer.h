...
public:
	...
	void DrawLine(const FVector2f& Start, const FVector2f& End, int64 MaxSplit = 32);
	...
	void DoDraw(const FLinearColor &WireColor);
...
private:
	...
	FLinearColor _WireColor;
	const FConnectionParams* Params;
	TArray<TTuple<FVector2D, FVector2D, FVector2D, FVector2D>> DrawList;
