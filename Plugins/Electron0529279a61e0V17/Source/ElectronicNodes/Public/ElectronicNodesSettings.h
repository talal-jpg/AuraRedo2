...
public:
	...
	/* Activate ribbon cables for overlapping wires. */
	UPROPERTY(config, EditAnywhere, Category = "Crossing")
	bool ActivateCrossing = false;

	/* Style of wire crossing. Default: Gap */
	UPROPERTY(config, EditAnywhere, Category = "Crossing", meta = (EditCondition = "ActivateCrossing"))
	ECrossingStyle CrossingStyle = ECrossingStyle::Gap;

	/* Size of the crossing. Default: 4 */
	UPROPERTY(config, EditAnywhere, Category = "Crossing", meta = (EditCondition = "ActivateCrossing", ClampMin = "1.0"))
